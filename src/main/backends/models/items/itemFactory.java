...
public class itemFactory {
    public static Item createItem(ItemType type, String name, double price, String info) {
        return switch (type) {
            case Electronics -> new Electronics(Electronics.addId(), name, price, info);
            case Art -> new Art(Art.addId(), name, price, info);
            case Vehicle -> new Vehicle(Vehicle.addId(), name, price, info);
